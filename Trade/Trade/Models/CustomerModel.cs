    ...
    public class CustomerModel : RepositoryBase
    {
        ...
        public int AddUpdateCustomer()
        {
            ...
            try
            {
                ...
                objSqlParameter[7] = new SqlParameter("@IntCustomerIsActive", IntCustomerIsActive);
                objSqlParameter[8] = new SqlParameter("@IntStatus", IntCustomerStatus);
                objSqlParameter[8].Direction = ParameterDirection.Output;
                objSqlParameter[9] = new SqlParameter("@IntMode", IntMode);
                objSqlParameter[10] = new SqlParameter("@IntLoginID", DataBaseClass.Global.IntLoginID);
                SqlHelper.ExecuteNonQuery(objConnection.GetConnection(), CommandType.StoredProcedure, "SP_AddUpdateCustomer", objSqlParameter);
                IntCustomerStatus = Convert.ToInt32(objSqlParameter[8].Value);
            }
            catch (Exception ex)
            {
